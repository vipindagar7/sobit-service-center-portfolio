...
export default function Contact() {
    const [state, handleSubmit, reset] = useForm('mjkvrjjj');
    if (state.succeeded) {
        return <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
            <h1 className='text-center text-gray-600'>Form Submit Sucessfully</h1>
        </div>
    }
    return (
        <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
            ...
            <div className="mx-auto max-w-2xl text-center">
                <h2 className="text-balance text-4xl font-semibold tracking-tight text-indigo-600 sm:text-5xl">Let's connect </h2>
            </div>
